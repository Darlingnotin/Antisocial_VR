...
public:
     ...
     * <img alt="Avatar in T-pose" src="https://apidocs.DarlingVR.dev/images/t-pose.png" /></caption>
     ...
     * <a href="https://docs.DarlingVR.dev/create/avatars/avatar-standards.html">Avatar Standards</a>.
     ...
     * <a href="https://docs.DarlingVR.dev/create/avatars/avatar-standards.html">Avatar Standards</a>.</p>
     ...
     * <img alt="Avatar in T-pose with arm rotated" src="https://apidocs.DarlingVR.dev/images/armpose.png" /></caption>
     * // Set all joint translations and rotations to defaults.
     * var i, length, rotation, translation;
     * for (i = 0, length = MyAvatar.getJointNames().length; i < length; i++) {
     *     rotation = MyAvatar.getDefaultJointRotation(i);
     ...
     * <img alt="Avatar with neck stretched" src="https://apidocs.DarlingVR.dev/images/stretched-neck.png" /></caption>
     ...
     * @example <caption>Set your avatar to its default T-pose then rotate its right arm.<br />
     * <img alt="Avatar in T-pose" src="https://apidocs.DarlingVR.dev/images/armpose.png" /></caption>
     * // Set all joint translations and rotations to defaults.
     * var i, length, rotation, translation;
     * for (i = 0, length = MyAvatar.getJointNames().length; i < length; i++) {
     *     rotation = MyAvatar.getDefaultJointRotation(i);
     ...
     *     {@link https://docs.DarlingVR.dev/create/avatars/avatar-standards.html#blendshapes Avatar Standards}.
