...
Item {
    ...
    clip: true
    readonly property string termsContainerText: qsTr("By creating this user profile, you agree to DarlingVR's Terms of Service")
    width: root.width
    height: root.height
    ...
    Item {
        ...
        Item {
            ...
            TextMetrics {
                ...
                Component.onCompleted: {
                    // with the link.
                    termsText.text = qsTr("By creating this user profile, you agree to <a href='https://DarlingVR.io/termsofservice'>DarlingVR's Terms of Service</a>")
                }
            }
