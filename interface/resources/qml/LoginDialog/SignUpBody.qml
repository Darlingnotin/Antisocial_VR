...
Item {
    ...
    height: root.height
    width: root.width
    readonly property string termsContainerText: qsTr("By signing up, you agree to DarlingVR's Terms of Service")
        ...
        Item {
            ...
            Item {
                ...
                TextMetrics {
                    ...
                    Component.onCompleted: {
                        // with the link.
                        termsText.text = qsTr("By signing up, you agree to <a href='https://DarlingVR.io/termsofservice'>DarlingVR's Terms of Service</a>")
                    }
                }
