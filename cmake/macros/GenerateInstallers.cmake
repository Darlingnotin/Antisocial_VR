...
macro(GENERATE_INSTALLERS)
  ...
  if (CLIENT_ONLY)
    ...
    string(REGEX REPLACE "DarlingVR" "DarlingVR Interface" _DISPLAY_NAME ${BUILD_ORGANIZATION})
  elseif (SERVER_ONLY)
    set(_PACKAGE_NAME_EXTRA "-Sandbox")
    set(INSTALLER_TYPE "server_only")
    string(REGEX REPLACE "DarlingVR" "DarlingVR Sandbox" _DISPLAY_NAME ${BUILD_ORGANIZATION})
  else ()
  ...
  set(CPACK_PACKAGE_VENDOR "DarlingVR")
  set(CPACK_PACKAGE_VERSION ${BUILD_VERSION})
  set(CPACK_PACKAGE_FILE_NAME "DarlingVR-Alpha${_PACKAGE_NAME_EXTRA}-${BUILD_VERSION}")
  ...
  if (BUILD_CLIENT)
    cpack_add_component(${CLIENT_COMPONENT} DISPLAY_NAME "DarlingVR Interface")
  endif ()

  if (BUILD_SERVER)
    cpack_add_component(${SERVER_COMPONENT} DISPLAY_NAME "DarlingVR Sandbox")
  endif ()
